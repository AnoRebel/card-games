...
type ServerMsg =
  ...
  | {
      t: "joined";
      youAre: { clientId: string; seat: Seat | null; spectator: boolean };
      isHost: boolean;
    }
    ...
    switch (msg.t) {
      ...
      case "room":
        ...
        this.roomInfo = {
          ...
          seated: msg.room.members.filter((m) => m.seat !== null && m.connected).length,
      ...
      case "state":
        this.view = {
          ...
          scores: msg.scores,
          isMyTurn: this.viewerSeat !== null && msg.state.activeSeat === this.viewerSeat,
        };
